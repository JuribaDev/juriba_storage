...
RSpec.describe Domain::Entities::Blob do
  ...
  describe "#initialize" do
    ...
    context "with invalid parameters" do
      ...
      it "raises an error when id is not a valid UUID" do
        allow_any_instance_of(described_class).to receive(:valid_uuid?).and_return(false)
        ...
        }.to raise_error(ArgumentError, "Blob ID must be a valid UUID")
      end
    end
  end
